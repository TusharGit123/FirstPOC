              ...
              <div className="container text-center">
                  ...
                  <div className="col-4"></div>
                      <div className="col-4 login-align">
                        ...
                        <InputComponent img={require("./../../assets/Images/usernamepic.svg")} labeltext={'Username'} name={'Username'} type={"Username"} place={"eg. James Bond"} inputclass={ 'form-control input-bottomblack' }/>
                        <InputComponent labeltext={'Password'} name={'password'} type={"password"} place={"*****"} inputclass={ 'form-control input-bottomblack' }/>                       
